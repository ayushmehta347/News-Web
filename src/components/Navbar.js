    ...
    <div className="container-fluid">
      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li className="nav-item">
            {/* //Link use kar rhe instaed of a href taki relod na ho */}
      ...
      <div className='bg-danger rounded mx-2' onClick={()=>{props.toggleMode('danger')}} style={{height:'30px',width:'30px'}}>
        ...
        {/* ternary oper use hua agr mode dark hai tho Dark mode light m likha hoga vise versa */}
...
Navbar.propTypes={title:PropTypes.string.isRequired}//setting the prop data type taki agr number pass krde koi tho error show aaaje 
                                                    //use isRequired to make it necesary for  any   prop
Navbar.defaultProps={//agr prop nhi passs hua tho default prp idhr se set hoga
